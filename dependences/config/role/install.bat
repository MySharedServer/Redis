...
set servicenamecmd='call readini.bat "%parentpath%redis.ini" [Role] role_name'
...
"%redisdir%\redis-server" --service-install "%~dp0redis.windows.conf" --service-name %servicename%
